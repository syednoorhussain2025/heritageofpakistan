    ...
    <div className="min-h-screen bg-[#f4f4f4]">
      ...
      <div className="w-full max-w-[calc(100%-200px)] mx-auto px-4 my-6 lg:flex lg:items-start lg:gap-6">
        ...
        <aside className="space-y-5 w-full lg:w-80 lg:flex-shrink-0">
          ...
          <Section title="Climate & Topography" iconName="climate-topography">
        ...
        <main className="space-y-5 w-full lg:flex-1">
          <Section title="Heritage Categories" iconName="heritage-categories">
            {categories.length > 0 ? (
          ...
          {site.history_content && (
            <Section title="History & Background" iconName="history-background">
          ...
          <Section title="Photography & Content" iconName="photography-content">
            <div className="font-sidebar-text">
          ...
          >
            {biblio.length ? (
              ...
              <div className="font-sidebar-muted-text">No sources listed.</div>
            )}
          </Section>
