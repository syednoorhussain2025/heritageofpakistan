...
function Section({
  ...
  return (
    <section className="bg-gray-800 border border-gray-700 rounded-xl shadow-md">
    ...
    <AdminGuard>
      ...
      <div className="min-h-screen bg-gray-900 text-gray-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-6">
            <div className="inline-flex rounded-lg border border-gray-700 bg-gray-800 overflow-hidden">
              <button
          ...
          {error && (
            <div className="mb-4 p-3 rounded bg-red-900/50 text-red-400 border border-red-500/30">
              {error}
            </div>
          )}
          {ok && (
            <div className="mb-4 p-3 rounded bg-emerald-900/50 text-emerald-400 border border-emerald-500/30 inline-flex items-center gap-2">
              <FaCheckCircle /> {ok}
            </div>
          )}
              ...
              <Section title="Upload a font">
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="mt-1 w-full border border-gray-600 rounded-lg px-3 py-2 bg-gray-700 text-white focus:ring-blue-500 focus:border-blue-500"
                      />
                    </div>
                    <div>
                      <label className="text-sm font-medium text-gray-400">
                  ...
                  <button
                    ...
                    disabled={busy}
                    className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-white bg-blue-600 hover:bg-blue-700 disabled:opacity-60 transition-colors"
                  >
              ...
              <Section title="Your custom fonts">
                {loading ? (
                  ...
                  <div className="space-y-4">
                    ...
                    0 ? (
                      <div className="text-gray-500">No custom fonts yet.</div>
                    ) : (
                      rows
                        ...
                        .map((r) => (
                          <div
                            key={r.id}
                            className="border border-gray-700 rounded-lg p-4 flex items-center justify-between bg-gray-800/50"
                          >
                            <PreviewFace row={r} />
                            <div>
                              ...
                              {r.url && (
                                <a
                                  className="mt-2 inline-flex items-center gap-1 text-blue-400 hover:underline text-sm"
                                  href={r.url}
                                  target="_blank"
                                  rel="noreferrer"
                                >
                            ...
                            <button
                              ...
                              className="ml-4 px-3 py-2 rounded-lg bg-red-900/50 hover:bg-red-900 text-red-400 border border-red-500/30"
                              disabled={busy}
                              title="Delete font"
                            >
                              <FaTrash />
                ...
                <div className="space-y-4">
                  ...
                  {googleHref && (
                    <div>
                      ...
                      <a
                        className="mt-1 text-sm text-blue-400 hover:underline break-all block"
                        href={googleHref}
                        target="_blank"
                        rel="noreferrer"
                      >
              ...
              <Section title="Your Google Fonts">
                {loading ? (
                  ...
                  <div className="space-y-4">
                    ...
                    0 ? (
                      <div className="text-gray-500">No Google fonts yet.</div>
                    ) : (
                      rows
