      ...
      <div className="min-h-screen bg-slate-100/70 text-slate-800">
        <main className="mx-auto max-w-7xl py-10 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex gap-6">
              ...
              <div className="space-y-1">
                {filtered.map((c) => (
                  <Link
                    key={c.href}
                    href={c.href}
                    className="group block rounded-full border border-slate-200 bg-white px-4 py-2 transition-all hover:shadow-md"
                  >
            ...
            {/* Right content area */}
            <section className="flex-1 rounded-xl bg-slate-100 p-6">
