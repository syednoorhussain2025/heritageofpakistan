  ...
  return (
    <div className="w-[calc(100%+0.5rem)] -mx-1 sm:w-full sm:mx-0 rounded-[20px] overflow-hidden bg-white relative border border-[var(--brand-light-grey)]">
      ...
      <Link
        ...
        onClick={onCardClick ? (e) => { e.preventDefault(); e.stopPropagation(); void hapticMedium(); onCardClick(); } : undefined}
      >
        <div className="relative">
          ...
          {hasDistance && (
            <div
              className="absolute bottom-3 right-3 px-3 py-1.5 rounded-lg bg-[var(--brand-green)] text-white shadow-xl flex items-center justify-center font-extrabold text-[13px] z-20"
              title={distanceLabel}
