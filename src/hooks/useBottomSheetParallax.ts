...
const TRANSITION_OPEN  = `transform ${DURATION_MS}ms cubic-bezier(0,0,0.2,1), border-radius ${DURATION_MS}ms cubic-bezier(0,0,0.2,1), filter ${DURATION_MS}ms cubic-bezier(0,0,0.2,1)`;
const TRANSITION_CLOSE = `transform ${DURATION_MS}ms cubic-bezier(0,0,0.2,1), border-radius ${DURATION_MS}ms cubic-bezier(0,0,0.2,1), filter ${DURATION_MS}ms cubic-bezier(0,0,0.2,1)`;
const BODY_TRANSITION_OPEN  = `background-color ${DURATION_MS}ms cubic-bezier(0,0,0.2,1)`;
const BODY_TRANSITION_CLOSE = `background-color ${DURATION_MS}ms cubic-bezier(0,0,0.2,1)`;
